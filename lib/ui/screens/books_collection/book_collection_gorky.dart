                                  ...
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                              'собое место в коллекции детских книг МКУК ЦСДБ  г. Челябинска по праву занимают книги А. М. Горького, поскольку Центральная городская детская библиотека носит имя этого писателя. Нас часто спрашивают, почему библиотека носит имя Алексея Максимовича Горького?',
                                          style: GoogleFonts.oswald(
                                              textStyle: Theme.of(context)
                                                  .textTheme
                                                  .headline5!),

...
class AfishaSaturday extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Map<String, String> events = {
      ...
      '14:30':
          'Интерактивное образовательное занятие «Умный пол» - «Весёлые рассказы» (6-10 лет)',
      '15:00': 'Мультстудия «Настроение» - «Работа над сценарием» (от 10 лет)',
      '15:00 ':
          'Кружок «Киберзнайка» Тема: Основы работы в редакторе презентаций (от 7 лет)',
      '15:30':
          'Кружок «Киберзнайка» Тема: Основы работы в редакторе презентаций (от 7 лет)',
      '16:00': 'Мастер класс по росписи тарелки «Золотая Хохлома»',
      '17:00':

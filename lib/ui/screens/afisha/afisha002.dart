...
class AfishaSecond extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Map<String, String> events = {
      '11:00':
          'Проект «Библионяня». Развивающее занятие «Форма и цвет. Квадрат» (От 1,5 до 3 лет)',
      '12:00':
          'Литературный час по книге Эллы Фоняковой «Хлеб той зимы», посвященный Блокаде Ленинграда (От 10 лет)',
      '14:00':
          'Программа «ЭКО что-то». Экологический урок «Лес и климат» (От 7 лет)',
      '16:00': '«Интеллектуальная игра «Литературные гонки» (от 12 лет)',
      '17:00':
          'Клуб любителей настольных игр «Сто наСтолок». Игра «ДаНетки» (от 10 лет)',
      '17:00':
          'Проект «Библионяня». Развивающее занятие «Форма и цвет. Квадрат» (От 1,5 до 2,1 лет)',
      '18:00':
          'Проект «Библионяня». Развивающее занятие «Форма и цвет. Квадрат» (От 2,1 до 3 лет)',
    };

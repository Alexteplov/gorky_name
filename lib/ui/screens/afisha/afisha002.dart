...
class AfishaSecond extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Map<String, String> events = {
      '11:00':
          'Проект «Библионяня». Развивающее занятие «Предметы вокруг нас. Машины» (1,5-3 лет)',
      '14:00': 'Настольная игра «Президент» от ЦМПИ (от 12 лет)',
      '16:00':
          'Клуб любителей настольных игр «Сто наСтолок». Игра «Фактор цвета» (от 12 лет)',
      '17:00':
          'Проект «Библионяня». Развивающее занятие «Предметы вокруг нас. Машины» (1,5-2 лет)',
      '18:00':
          'Проект «Библионяня». Развивающее занятие «Предметы вокруг нас. Машины» (2,1-3 лет)',
    };

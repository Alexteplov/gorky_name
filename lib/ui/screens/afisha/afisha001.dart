...
class AfishaFirst extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /*    final Map<String, String> events = {
      ...
      '16:30':
          'Литературно-игровое занятие «Ребята и зверята Ольги Перовской» (5-7 лет)',
    };

    final Map<String, String> eventsA = {
      '11:30':
          'Творческое занятие «Умелые пальчики» - объемная аппликация «Весенняя песенка» (1,5-3 лет)',
      '14:00':
          'Кинопросмотр и обсуждение фильма  «Наследники Победы» с обзором художественных книг. Тема: «Патриотизм» (от 8 лет)',
      '14:30': 'Исторический час «Великая война - Великая ПОБЕДА» (7-9 лет)',
      '15:30': 'Исторический час «Великая война - Великая ПОБЕДА» (7-9 лет)',
      '16:00':

...
/*
    ...
    final Map<String, String> eventsA = {
      ...
      '17:00':
          'Кинопросмотр и обсуждение фильма «Урок экологии» с обзором художественных книг. Тема: «экология», «ответственность» (от 12 лет)',
      '17:30': 'Шахматный клуб «Ход конем» (от 7 лет)',
    };

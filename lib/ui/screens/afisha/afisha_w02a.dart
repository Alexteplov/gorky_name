 ...
 */
  ...
  Widget build(BuildContext context) {
    final Map<String, String> events = {
      ...
      '12:00':
          'Клуб «РасЧитайка». Литературно-игровое занятие «По следам Винни-Пуха» (4-7 лет)',
      '14:15':
          'Клуб по развитию лидерских качеств и организаторских способностей «ProЯвись». Тема «Портрет лидера» (от 12 лет)',
      '14:30':
          'Интерактивное образовательное занятие «Умный пол» - «Английский язык» (от 8 лет)',
      '16:00':
          'Клуб «БиблиоБЛОГИНГ». Занятие по теме: «Особенности речи в формате публичного выступления» (от 10 лет)',
      '16:00 ': 'Кинопросмотр и обсуждение мультфильма «Рататуй» (8-12 лет)',
      '16:30':
          'Кружок «Сказка на песке». Тема занятия «Песочная геометрия» (3-5 лет)',
    };

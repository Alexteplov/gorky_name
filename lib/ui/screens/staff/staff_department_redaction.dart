...
class StaffDepartmentRedaction extends StatefulWidget {
  const StaffDepartmentRedaction({Key? key}) : super(key: key);

  @override
  _StaffDepartmentRedactionState createState() =>
      _StaffDepartmentRedactionState();
}

class _StaffDepartmentRedactionState extends State<StaffDepartmentRedaction> {
                            ...
                            child: GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  _image = StaffData.staffDepRedactMat;
                                  //print(_showPreview);
                                });
                              },
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        text:
                                            'Заведующий редакционно-издательским отделом ЦГДБ им. А. М. Горького.\n\n',
                                        style: GoogleFonts.oswald(
                                            textStyle: Theme.of(context)
                                                .textTheme
                                                .headline5!
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                " – Концепция оформления пространства и рекламной полиграфии детских библиотек МКУК ЦСДБ г. Челябинска.",
                            style: GoogleFonts.oswald(
                              textStyle: Theme.of(context)
                                  .textTheme
                                  .headline5!
